...
class paloMenu {
    ...
    function cargar_menu()
    {
       //leer el contenido de la tabla menu y devolver un arreglo con la estructura
        $menu = array ();
        $query="Select m1.*, (Select count(*) from menu m2 where m2.IdParent=m1.id) as HasChild from menu m1 where m1.status = 1 order by order_no asc;";
...
WHERE acl_resource_name = id and status = 1 ORDER BY order_no;
INFO_AUTH_MODULO;
