...
function _moduleContent(&$smarty, $module_name)
{
    ...
    $xajax = new xajax();
    $xajax->register(XAJAX_FUNCTION, "mostrar_menu");
...
function mostrar_menu($level, $id_module_level_1, $id_module_level_2, $id_module_level_3)
{
    ...
    if($level==1)
    {
        $respuesta->assign("level_2","innerHTML", "");
        $respuesta->assign("level_3","innerHTML", "");
    }
    //Nivel 2
    if($level==2 || $level==3)
    {
        ...
        $respuesta->assign("level_2","innerHTML", $level_2);
        $respuesta->assign("level_3","innerHTML", "");
    }
    //Nivel 3
    if($level==3)
    {
        ...
        $level_3 .= "</td>";
        $respuesta->assign("level_3","innerHTML", $level_3);
    }
