...
<html>
    ...
    <link rel="stylesheet" href="{$WEBPATH}themes/{$THEMENAME}/css/datatables.min.css"/>
...
{/if} 
        ...
        <!-- Bootbox.js -->
        <script type='text/javascript' src="{$WEBPATH}themes/{$THEMENAME}/js/bootbox.min.js"></script>
        <!-- Datatables.min.js de bootstrap -->
        <script type="text/javascript" src="{$WEBPATH}themes/{$THEMENAME}/js/datatables.min.js"></script>
        
        {if $smarty.session.menu eq "agent_console"}{literal}
