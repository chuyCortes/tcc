    ...
    foreach ($cadavalor as $value) {
        ...
        switch ($this->structure[$field]['input']){
            ...
            case 'textarea':
                ...
                printf('<textarea %s name="%s" class="form-control input-xlarge" %s>%s</textarea>',$style,$fieldp,$attribute,$value);
                if ($this->structure[$field]['template']=='inline') {
                     echo '</div>';
                } 
                break;
            case 'multiselect':
                printf('<div class="col-sm-9"><select data-placeholder="%s" %s name="%s[]" size="7" class="form-control %s" multiple %s>',__("Select some options"),$style,$fieldp,$chzclass,$attribute);
            ...
            case 'select':
                ...
                printf('<select data-placeholder="%s" %s name="%s" class="form-control %s" %s>',__("Select an option"),$style,$fieldp,$chzclass,$attribute);
                foreach ($this->structure[$field]['values'] as $k => $v) {
                    $vprint = $this->get_edit_filtered($field,$v);
                ...
                break;
            case 'bitmask':
                printf('<div class="col-sm-9"><select data-placeholder="%s" class="chz form-control" name="%s[]" %s  size="7" multiple>',__("Select some options"),$fieldp,$attribute);
                foreach ($this->structure[$field]['values'] as $k => $v) {
            ...
            case 'datetime':
                ...
                printf('<div class="col-sm-2"><div class="input-group"><input type="text" name="%s" class="form-control dateTime" xdata-datepicker="datepicker" value="%s" %s /><span class="input-group-addon"><span class="fa fa-calendar"></span></span></div></div>',$fieldp,$vprint,$attribute);

                break;
            case 'date':
                $vprint = $this->get_edit_filtered($field,$value);

                printf('<div class="col-sm-2"><div class="input-group datePick"><input type="text" name="%s" class="form-control" value="%s" %s /><span class="input-group-addon"><span class="fa fa-calendar"></span></span></div></div>',$fieldp,$vprint,$attribute);
                break;
                /*
                   case 'time':
            ...
            case 'password':
                printf('<div class="col-sm-9"><input type="password" class="from-control" name="%s" value="%s" %s /><input type="password" name="%s_confirm" class="form-control" value="%s" %s> <i>(confirmar)</i><label class="checkbox"><input type="checkbox" value="1" name="%s_blank" id="%s_blank">Dejar clave en blanco?</label></div>',
                        $fieldp,$value,$attribute,$fieldp,$value,$attribute,$fieldp,$fieldp,$fieldp);
                break;
            case 'hidden':
            ...
            case 'img':
                ...
                break;
             case 'email':
                printf('<div class="controls"><input class="form-control %s" type="email" name="%s" value="%s" %s /></div>',$style,$fieldp,$value,$attributes);
                break;
             case 'url':
                printf('<div class="controls"><input class="form-control %s" type="url" name="%s" value="%s" %s /></div>',$style,$fieldp,$value,$attributes);
                break;
             case 'number':
                if ($this->structure[$field]['template']=='inline') {
                     echo '<div class="col-sm-9">';
                }
                printf('<input class="form-control %s" type="number" name="%s" value="%s" %s %s />',$style,$fieldp,$value,$attribute,$required);
                if ($this->structure[$field]['template']=='inline') {
                     echo '</div>';
                }
                break;
             case 'bool':
                ...
                printf('<div class="controls"><input type="hidden" value="off" name="%s"><input class="form-control chz100 %s" data-toggle="toggle" class="chk" data-size="mini" type="checkbox" name="%s" %s %s /></div>',$fieldp,$style,$fieldp,$checked,$attributes);
                break;
            default:
                $required='';
                ...
                printf('<input class="form-control %s" type="text" name="%s" value="%s" %s %s />',$style,$fieldp,$value,$attribute,$required);
                if ($this->structure[$field]['template']=='inline') {
                     echo '</div>';
                }
                break;
